  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Administrator</h2>
          <p>In this section you need to enter the desired login id, that login id will
          take you the Corresponding page.  </p>
        </div>
        <div class="article">
          <h2>Enter the LOGIN ID</h2>
          <form action="Login">
            <ol>
                <%
        ...
        %>
              ...
              <li>
                <label for="name">Login ID (required)</label>
