 ...
 * @author sony
 */
public class Rcomputation extends HttpServlet {
...
int dater,datei,moni,monr,yeari,yearr,output,feb=28,fine=0,cfine;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         int x;
        String studentname = null,bi="BOOK REISSUE TO";
        ...
        try {
         ...
         if(output>14)
         {
            ...
            fine=fine+pf;
              x=st.executeUpdate("update "+name+" set issuedate='"+datereturn+"' where bookid='"+bookid+"'");
            ...
            x=st.executeUpdate("insert into cfine values ('"+bookid+"','"+studentid+"','"+datereturn+"','','0','"+studentbranch+"')");
